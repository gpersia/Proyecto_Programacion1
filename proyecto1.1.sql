...
CREATE TABLE `chofer` (
  ...
  `tipo_transporte_id` int(11) NOT NULL,
  PRIMARY KEY (`chofer_id`),
  KEY `documento` (`documento`),
  KEY `vehiculo_id` (`vehiculo_id`),
  KEY `sistema_id` (`sistema_id`),
  KEY `fk_chofer_tipo_transporte1_idx` (`tipo_transporte_id`),
  ...
  CONSTRAINT `fk_chofer_tipo_transporte1` FOREIGN KEY (`tipo_transporte_id`) REFERENCES `tipo_transporte` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipo_transporte` (
  ...
  `vehiculo_vehiculo_id` int(4) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_tipo_transporte_vehiculo1_idx` (`vehiculo_vehiculo_id`),
  CONSTRAINT `fk_tipo_transporte_vehiculo1` FOREIGN KEY (`vehiculo_vehiculo_id`) REFERENCES `vehiculo` (`vehiculo_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `vehiculo` (
  ...
  KEY `fk_vehiculo_tipo_transporte1_idx` (`tipo_transporte_id`),
  CONSTRAINT `fk_vehiculo_tipo_transporte1` FOREIGN KEY (`tipo_transporte_id`) REFERENCES `tipo_transporte` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-11-13 11:52:35
